...
控制台由 `run-web-product-workflow` 在建立本项目治理目录时装配。skill 里的那一份是**模板**；能跑的这一份属于本项目。
...
<!-- LG-MANAGED:START -->
- 装配时间：`2026-09-04T07:12:29Z`
- 来源 skill：`run-web-product-workflow` 版本 `6.3.0-candidate`
- 装配时的 skill 路径：`D:\LFEN_project\dev_project\LFen-Skills\skills\product-engineering\run-web-product-workflow`
