...
# One source for the sealed set: governance_artifacts owns it, and this audit checks
# against it rather than keeping a second copy that has to be edited in step.
EXPECTED_ROLES = dict(EXPECTED_MANIFEST_ROLES)
...
def query_gateway_evaluation(
    *,
    ...
    evaluation = {
        ...
        "query_engine": {
            "path": "run-governed-product-workflow/scripts/query_norm_context.py",
...
def main() -> int:
    ...
    try:
        ...
        report = {
            ...
            "generated_at": now_utc(),
            "generator": {
                "path": "run-governed-product-workflow/scripts/audit_norm_retrieval.py",
