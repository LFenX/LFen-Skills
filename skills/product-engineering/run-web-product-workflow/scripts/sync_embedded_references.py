        ...
        json.dumps(
            {
                ...
                "source_of_truth": "LFen-Skills/skills/product-engineering/run-web-product-workflow; the embedded runtime assets are the sole editing source of truth for the norms, mappings, schemas and evaluations they contain",
                "files": manifest,
            },
            ensure_ascii=False,
            indent=2,
